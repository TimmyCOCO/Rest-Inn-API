...
public class EntityController {
	...
	public ResponseEntity<List<RestInnEntity>> getEntitiesByType(@RequestParam String type){
		return new ResponseEntity<>(entityService.getEntitiesByType(type), HttpStatus.OK);
	}
